        ...
        <table id="brandTable" class="table table-striped table-hover">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <form class="d-inline" action="{{ route('admin.brands.destroy', ['brand' => $brand->id]) }}" method="POST">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn btn-outline-danger"><i class="fas fa-trash"></i> Hapus</button>
                            </form>
                            <span class="d-inline-block mx-2" >|</span>
                            <a href="{{ route('admin.brands.show', ['brand' => $brand->id]) }}" class="btn btn-outline-primary">Detail >></a>
                        </div>
                    </td>
                </tr>
                @endforeach
