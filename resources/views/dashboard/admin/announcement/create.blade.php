...
<div class="card mb-4">
    <div class="d-flex align-items-center justify-content-between">
        ...
        <h6 class="card-header fw-bold"><span class="text-muted fw-light">Dashbaord / Manajemen Pengumuman /</span> Tambah Data Pengumuman</h6>
    </div>
</div>


<form class="row" action="{{ route('admin.announcements.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="col-7">
        <div class="card">
            <h5 class="card-header">Tambah Data Pengumuman</h5>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <textarea class="form-control" name="body" id="body" rows="5" autocomplete="off">{{ old('body') }}</textarea>
                        @error('body')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <div class="border p-2 d-flex flex-column justify-content-center align-items-center">
                            ...
                            <img class="d-block" id="coverImagePreview" style="width: 100%">
                        </div>
                    </div>
                </div>
            </div>
