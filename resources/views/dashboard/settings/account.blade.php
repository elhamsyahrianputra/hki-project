                ...
                <form id="formAccountSettings" action="{{ route('profile.update') }}" method="POST" novalidate>
                    ...
                    <div class="row">
                        <div class="mb-3 col">
                            ...
                            <textarea class="form-control @error('about_me') @enderror" name="about_me" id="about_me" cols="30" rows="4" placeholder="Tuliskan sesuatu">{{ old('about_me', auth()->user()->about_me) }}</textarea>
