                    ...
                    <div class="timeline-step">
                        <div class="timeline-content" data-toggle="popover" data-trigger="hover"
                            data-placement="top" title="">
                                ...
                                @elseif (in_array("accepted", $status_history) || in_array("revision", $status_history)  || in_array("revised", $status_history) || in_array("rejected", $status_history))
                                    <div class="text-success"><i class="fas fa-check-circle"></i></div>
                                @else
                    ...
                    <div class="col">
                            ...
                            <div class="col">
                                <div class="table-responsive text-nowrap mb-4 shadow">
                                    <table class="table table-striped text-center" id="table-pdki">
                                        ...
                                        <tbody id="item-pdki">
                                            <tr>
                                                <td colspan="4">Data belum ditemukan</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="row mb-4 text-center justify-content-center">
                            <div class="col-10 d-grid">
                                ...
                                <a href="{{ asset($brand->logo_url) }}" target="_blank" class="btn btn-dark rounded-pill"><i class="bx bx-link-external"></i> Lihat Logo</a>
                            </div>
                        </div>
                        <div class="row mb-4 text-center justify-content-center">
                            <div class="col-10 d-grid">
                                <h6 class="mb-2">Signature</h6>
                                <a href="{{ asset($brand->signature_url) }}" target="_blank" class="btn btn-dark rounded-pill"><i class="bx bx-link-external"></i> Lihat Tanda Tangan</a>
                            </div>
                        </div>
                        <div class="row mb-4 text-center justify-content-center">
                            <div class="col-10 d-grid">
                                <h6 class="mb-2">Surat Keterangan UMK</h6>
                                <a href="{{ asset($brand->certificate_url) }}" target="_blank" class="btn btn-dark rounded-pill"><i class="bx bx-link-external"></i> Buka File PDF</a>
                            </div>
                        </div>
                    </div>
                </div>
