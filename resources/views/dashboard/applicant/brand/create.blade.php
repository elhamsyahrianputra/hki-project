    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="col-md-7">
                    <form id="formAccountSettings" action="{{ route('applicant.brands.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <div class="d-flex">
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" id="name" name="name" value="{{ old('name') }}" autofocus  required />
                                    <a id="check-btn" class="btn btn-dark text-white ms-3">Check</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <input class="form-control @error('owner') is-invalid @enderror" type="text" id="owner" name="owner" value="{{ old('owner') }}" required />
                                @error('owner')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <input id="logoInpu" class="form-control @error('logo_url') is-invalid @enderror" type="file" id="logo" name="logo_url" accept=".jpg, .png" onchange="imagePreview('logoInpu', 'logoImagePreview')" required />
                                @error('logo_url')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <input id="signatureInput" class="form-control @error('signature_url') is-invalid @enderror" type="file" id="signature" name="signature_url" accept=".jpg, .png" onchange="imagePreview('signatureInput', 'signatureImagePreview')" required />
                                @error('signature_url')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col">
                            <div class="table-responsive text-nowrap mb-4 shadow">
                                <table class="table table-striped text-center" id="table-pdki">
                                    <thead class="bg-dark">
                                        <tr>
                                            <th class="text-white">Nama Merk</th>
                                            <th class="text-white">Class</th>
                                            <th class="text-white">Status</th>
                                            <th class="text-white">Similarity</th>
                                        </tr>
                                    </thead>
                                    <tbody id="item-pdki">
                                        <tr>
                                            <td colspan="3">Data belum ditemukan</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-7 p-2 border border-3">
    ...
    document.getElementById('check-btn').addEventListener('click', function() {
        ...
        .then(data => {
            ...
            data.forEach(item => {
                ...
                row.innerHTML = `<td>${item.name}</td><td>${item.class_no}</td><td><div class='badge bg-label-secondary'>${item.status}</div></td><td><div class='badge bg-label-dark'>${item.similarity}%</div></td>`;
